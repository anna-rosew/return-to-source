...
export const classes: ClassInfo[] = [
  {
    ...
    dates: ["Mon, Sep 1", "Mon, Sep 8", "Mon, Sep 15", "Mon, Sep 22"],
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Wed, Sep 3", "Wed, Sep 10", "Wed, Sep 17", "Wed, Sep 24"],
    times: ["7:00 - 7:30", "7:00 - 7:30", "7:00 - 7:30", "7:00 - 7:30"],
    dropInPrice: "£8",
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Thu, Sep 4", "Thu, Sep 11", "Thu, Sep 18", "Thu, Sep 25"],
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Full Moon: Sat, Sep 6", "Equinox New Moon: Thu, Sun 21"],
    times: ["8:00 - 9:00", "19:00 - 20:00"],
    dropInPrice: "£15",
