...
export const classes: ClassInfo[] = [
  {
    ...
    dates: ["Mon, May 75", "Mon, May 12", "Mon, May 19", "Mon, May 26"],
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Wed, May 7", "Wed, May 14", "Wed, May 21", "Wed, May 28"],
    times: ["7:00 - 7:30", "7:00 - 7:30", "7:00 - 7:30", "7:00 - 7:30"],
    dropInPrice: "£8",
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Thu, May 1", "Thu, May 8", "Thu, May 15", "Thu, May 22"],
  ...
  },
  {
    ...
    permanentDescription:
      "You can join this class anywhere in the world on Zoom.",
    dates: ["Full Moon: Tue, May 13", "New Moon: Tue, May 27"],
