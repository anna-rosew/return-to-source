...
export const serviceData: IServiceCard[] = [
  {
    ...
    description: 'Learn how to regain clarity, and calm the turmoil within you.',
    image: HomeOne,
  ...
  },
  {
    ...
    description: 'Discover how to reconnect with your body and the healing power within you.',
    image: HomeTwo,
