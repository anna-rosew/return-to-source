...
const MonthlyCard = (props: MonthlyCardProps) => {
  ...
  return (
    <div>
      ...
      <div className="group rounded-lg flex min-h-[330px] flex-col items-center justify-start text-black bg-customBeige text-center px-4 md:px-4 py-4 transition-colors duration-700 ease-in-out">
        <div>
