...
const DetailsCard = (props: DetailsCardProps) => {
  ...
  return (
    <div className="border group border-black rounded-lg  text-black  bg-transparent text-left px-4 md:px-4 py-8 md:py-16 mt-8 md:my-12 transition-colors duration-700 ease-in-out ">
      <div>
        <Icon
