...
import { RetreatProps } from "@/types/index";
    ...
    <div className=" pt-5 relative md:p-5 grid grid-cols-1 md:grid-cols-3 gap-5">
      <div className="flex flex-col justify-between">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${retreatInfo.backgroundImage})`,
          }}
        >
        ...
        <div className="text-left mt-4">
          ...
          <p
            dangerouslySetInnerHTML={{
              __html: formatDescription(retreatInfo.description),
            }}
          />
        </div>
            ...
            <div className="grid grid-cols-2 ">
              <div className="mb-4">
                ...
                <ul className="list-none py-2 text-sm">
                  {retreatInfo.dates.length > 0 ? (
                    retreatInfo.dates.map((date, index) => (
              ...
              <div className="mb-4">
                ...
                <ul className="list-none py-2 text-sm">
                  {retreatInfo.times.length > 0 ? (
                    retreatInfo.times.map((time, index) => (
                      <li key={index} className="py-2 border-b border-black">
                        {time}
                      </li>
                    ))
