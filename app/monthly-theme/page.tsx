          ...
          <div className="relative z-10 flex items-center justify-center h-full text-center px-4">
            <div>
              ...
              <p className="text-lg text-center max-w-2xl mx-auto text-white">
                A four-week Autumn Equinox journey to deepen your self-awareness and reclaim
      ...
      <div className="w-full container">
        ...
        <div className="mx-auto text-center mb-16">
          <p className="text-lg text-gray-700 mb-8">
            <strong>The light is here, and so are you!</strong> Let this Solstice be a return to
            your true nature, your chance to tap into the deep joy of being awake and alive to the
            wonder of each day. This gentle, low-screen-time program invites you to make this
            solstice a turning point— <strong>a joyful &apos;YES!&apos; </strong>to your vital
            spirit.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="flex flex-col items-center p-4 bg-transparent rounded-lg">
              ...
              <h3 className="font-semibold text-customSienna">Daily Practice</h3>
              <p className="text-gray-600">15 minutes</p>
              <p className="text-sm text-gray-500">No elaborate setup required</p>
            </div>
            <div className="flex flex-col items-center p-4 bg-transparent rounded-lg">
        ...
        {/* Weekly Program */}
        <div className="mb-16">
          <h2 className="text-3xl text-center text-customSienna mb-12">Your Three-Week Journey</h2>
        ...
        <div className="mb-16 rounded-lg p-8">
          <h2 className="text-2xl text-customSienna mb-6 text-center">Each Day Includes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-amber-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                  <span>A simple ritual to bring it into your body and day</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* What's Included */}
        <div className="mb-16">
          <h2 className="text-3xl text-center text-customSienna mb-12">Your Investment Includes</h2>
        ...
        <div className="text-center bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg p-12">
          <h2 className="text-3xl text-customSienna mb-6">Ready to Say YES to Light?</h2>
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            Mark this Summer Solstice as a pivotal moment in your year. Listen for your inner
            &#39;YES!&apos; and respond.
          </p>
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-700 mb-6">
            ...
            <span className="inline-flex items-center gap-x-2">
              <Link href="/contact" className="flex items-center font-medium text-customTeal">
