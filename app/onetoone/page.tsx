      ...
      <div className="container  w-full">
        ...
        <div className="mt-12">
          <p className="para">
            ...
            <strong>develop your inner guidance system.</strong> This requires a process of slowing
            down, breathing, and learning to listen and observe yourself. It can be uncomfortable
            and challenging at times. The Coaching Sessions offer a space of deep listening where
        ...
        <p className="para py-4">
          For the work to take root, you have <strong>daily practices</strong> and activities that
          embed what you’re learning into your daily life. Come with curiosity and an open mind.
          Your life <strong>will transform from the inside out.</strong>
        </p>
        <p className="para">
